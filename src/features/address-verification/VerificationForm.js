...
export class VerificationForm extends Component {
  ...
  handleSubmit = (e) => {
    const {
      code
    } = this.props.addressVerification
    e.preventDefault();
  ...
  render() {
      return ( <
        ...
        MaskedInput name = "code"
        autoFocus = {
          true
        }
        value = {
          this.props.addressVerification.code
        }
        onChange = {
          (e) => this.props.actions.changeCode(e.target.value)
        }
        mask = {
          [
        ...
        Form.Button disabled = {
          this.props.addressVerification.sendVerificationPending
        }
        positive > Submit < /Form.Button> <
        /Form> <
        /Segment> {
          this.props.addressVerification.sendVerificationPending && < h2 > Please wait... < /h2>} {
            !!this.props.addressVerification.response && < Message >
              ...
              p > < strong > Address: < /strong> <br / > {
                this.props.addressVerification.response['address']['name']
              } < br / > {
                this.props.addressVerification.response['address']['address_line1']
              } < br / > {
